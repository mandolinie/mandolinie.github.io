document.addEventListener('DOMContentLoaded', function () {
  ...
  // Find the script with the ID 'custom-script'
  const scriptPosition = document.getElementById('duotone');

  // Insert the style element after the custom script
  if (scriptPosition) {
    scriptPosition.insertAdjacentElement('afterend', styleElement);
  }
